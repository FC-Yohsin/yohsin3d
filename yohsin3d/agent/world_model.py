...
class WorldModel:
    def __init__(self, team_name="FCYohsin") -> None:
        self.cycle = 0
        self.time = -1.0
        self.gametime = -1.0
        ...
        self.last_ball_sighting_time = -1.0
        self.last_ball_seen_position = None
